let editProfileButton = document.querySelector('.button-edit');
...
let closePhotoButton = document.querySelector('.button-close_add-photo');
let addPhotoButton = document.querySelector('.button-add');
